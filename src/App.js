...
import ExpandirConteudo from './components/home/ExpandirConteudo';
import TabelaFome from './components/home/TabelaFome';
...
import Agradecimentos from './components/home/Agradecimentos';
import ImagemInstagram from './components/home/ImagemInstagram';
        ...
        {/* FIM RADIO BUTTON */}
          ...
          <Grid item xs={12} sm={12}>
            ...
            <a className="wpbtn" title="share to whatsapp" href="whatsapp://send?text=Para marcar no mapa e alimentar quem tem fome, achei esse site: www.mapafome.com.br"> <img className="wp" src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt=""/>
                ...
                <br/>
              Mapeados: {this.state.rowCount}<br/>
              ...
              <a target='_blank' rel="noreferrer" href="https://instagram.com/mapafome"><ImagemInstagram/></a>
            
              <br/>No mapa clique na bolinha para saber como ajudar.<br/> Você pode se incluir ou incluir outra pessoa, <br/>selecione a situação e confirme o local (mais informações <a target='_blank' rel="noreferrer" href="https://g1.globo.com/pe/pernambuco/noticia/2022/02/10/site-criado-por-estudante-da-ufpe-aproxima-pessoas-que-estao-passando-fome-e-doadores-de-comida.ghtml">na matéria da Globo</a>)(<a href="https://globoplay.globo.com/v/10350537/">e jornal hoje da Globo em rede nacional</a>):
              <br/><span className="yellowHub">  em amarelo são pessoas <img width="30px" height="30px" src={coffeeBean}></img></span>em vulnerabilidade social e insegurança alimentar que estão com fome em casa ou na rua, --precisam de alimento
              <br/><span className="blueHub">  em azul são pessoas <img width="30px" height="30px" src={hub}></img></span>que recebem alimentos ou recursos para distribuir alimento ou refeições na comunidade (exemplo: sopão solidário, ongs, voluntários) --precisam de doações
              <br/><span className="redHub">  em vermelho são pessoas <img width="30px" height="30px" src={red}></img></span>que entregam refeição em ponto fixo na rua em certo dia na semana. --ponto de entrega de alimento pronto
              <br/><span className="greenHub">  em verde são pessoas <img width="30px" height="30px" src={green}></img></span>que trabalham com alimentos e precisam destinar os alimentos não comercializados ou não consumidos e não tem pessoas para buscar esses alimentos (exemplo: restaurante, hotel, lanchonete, feira livre, supermercados) --precisam de voluntários para buscar 
      

            <br/>
            <br/>
            <img className="ods alignElementCenter" alt="" src="https://brasil.un.org/profiles/undg_country/themes/custom/undg/images/SDGs/pt-br/SDG-2.svg"></img> 
            <br/>
            No Mapa Fome você pode encontrar a quem ajudar e fazer novas marcações, caso uma opção represente você ou outra pessoa, selecione, coloque número para contato se quiser, e confirme com localização atual ou endereço e número
        
          
            <br/><br/>serve para 

            <br/>-mapear pessoas que estão com fome na rua ou em casa
            <br/>-mapear iniciativas que recebem recursos para fazer doação
            <br/>-mostrar no mapa onde e quando tem alimento sendo distribuído
            <br/>-mostrar no mapa lugares comerciais ou residenciais que precisam de voluntários ou necessitados para buscar alimentos não consumidos ou não comercializados
            <br/> é possível traçar uma rota ao destino ao clicar Ir para o destino, e ser redirecionado para o Google Maps
            <br/>

            <p>
              <ExpandirConteudo componente={Agradecimentos} texto={"Agradecimentos"} />
            </p>
            
            <p>
              <ExpandirConteudo componente={TabelaFome} texto={"Ver tabela de consequências ruins ao longo do tempo"} />
            </p>
            
            {/* Conclusão */}
            <p>
                Conclusão: Faço um apelo a você tomar medidas e ações solidárias e qualquer forma de iniciativa recorrentes, em intervalos de 1 dia a 14 dias (intervalos recorrentes de mínimo diário ou menos, máximo 2 semanas ou menos), alivie a dor e sofrimento de outro ser humano.
            </p>
